  ...
  return (
    <div>
      ...
      <Stack spacing={3} my="12px">
        ...
        >
          <Editable
            defaultValue="Write some descritption for Board .."
            fontSize="sm"
          >
            <EditablePreview />
            <EditableTextarea
    ...
    return (
        <div>
            <HStack justify='space-between'>
                ...
                {profile.admin ? <chakra.small> admin </chakra.small> : <Button size='xs' colorScheme='red' variant='outline'> remove </Button>}
            </HStack> 
        </div>
    )
}